...
void MainWindow::createActions()
{
    ...
    actionSaveFiles = new QAction("Export as .txt");
    exportAsPdfForResult = new QAction("Export As .PDF");
    actionPrint = new QAction("Print");

    actionSaveAsText = new QAction("as .txt");
...
void MainWindow::initMemWidget()
{
    ...
    // result list view
        ...
        // ---- Qmenu ----------
        menu = new QMenu();
        menu->addAction(actionSaveAsText);
...
{
    connect(ui->openListView, SIGNAL(clicked(const QModelIndex &)), this, SLOT(onOpenListViewItemClicked()));
    ...
    connect(ui->resultListView,SIGNAL(clicked(const QModelIndex &)), this, SLOT(onResultListViewItemClicked()));
    ...
    // ------------- QMenu ------------------
    connect(actionSaveAsText,SIGNAL(triggered()),this,SLOT(on_saveFiles()));
    connect(actionSaveAsPdf,SIGNAL(triggered()),this,SLOT(on_savePDFFiles()));
    // menu home
    connect(actionHome,SIGNAL(triggered()),this,SLOT(on_home()));
...
void MainWindow::onResultListViewItemClicked(int index)
{
...
bool MainWindow::saveBinBrille(QStringList binData)
{
