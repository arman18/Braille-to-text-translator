...
void progressWidget::setMaximum(int numberOfLine, int numberOfFile)
{
    ...
    QString safe= "QProgressBar::chunk {background: rgb(144,238,144); border-bottom-right-radius: 7px;border-bottom-left-radius: 7px;border: 1px solid black;}";
    individualProgressBar->setStyleSheet(safe);
